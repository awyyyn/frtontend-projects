...
const Navbar = ({handleNav, isNavOpen}: navbarProps) => {
    return (
        <>
            <nav className={`fixed top-0 left-0 w-screen shadow-lg bg-white z-[5] flex justify-between py-4 items-center px-6 sm:px-20 ${isNavOpen && 'hidden'} `}> 
                ...
                <button className="block sm:hidden" onClick={handleNav}> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15">
                        <path fill="#242A45" fill-rule="evenodd" d="M0 0h18v3H0V0zm0 6h18v3H0V6zm0 6h18v3H0v-3z"/>
                    </svg> 
                </button>
                <div className='sm:flex items-center md:gap-x-8 sm:gap-x-4 hidden '>
                    <a href='#features' className='link'>Features</a>
                    <a href='#pricing' className='link'>pricing</a>
                    <a href='#contact' className='link'>Contact</a>
                    <button className='py-2 hover:shadow-lg px-7 text-soft-red border border-soft-red font-[500] rounded-[4px] uppercase text-sm'>
                        login
                    </button>
                </div>
            </nav>
            ...
            <nav className={`fixed top-0 h-screen left-0 w-screen z-[5] flex sm:hidden ${!isNavOpen && 'hidden'}`}> 
                <div className="absolute h-screen w-screen top-0 z-[8]">
                    <div className="relative">
                        <div className="py-4 px-6 z-[6] flex flex-row ">
                            <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
                                <g fill="none" fillRule="evenodd">
                            ...
                            <button className="absolute right-6 top-6 sm:hidden" onClick={handleNav}> 
                        ...
                        <div className="flex flex-col  items-center mt-5">
                            <a 
                                href="#features" 
                                onClick={handleNav} 
                                className="text-white py-6 border-t border-grayish-blue w-[80%] text-center font-semibold text-xl tracking-wider hover:text-soft-red"
                            >
                                Features
                            </a>
                            <a 
                            ...
                            <a 
                                href="#contact" 
                                onClick={handleNav}
                                className="text-white py-6 border-t border-grayish-blue w-[80%] text-center font-semibold text-xl tracking-wider border-b hover:text-soft-red"
                            >
                                Contact
                            </a>
                            <button className="mt-5 py-2 w-[80%] border-2 border-white text-white font-bold tracking-widest rounded-md hover:text-soft-red hover:border-soft-red">
                                LOGIN
                            </button>
                        </div>
                    </div>
                </div> 
                <div className="flex absolute  justify-center z-[8] w-screen bottom-20 ">
                    <div className="flex gap-x-12 items-center w-full justify-center">
                ...
                <div className="h-full w-full bg-dark-blue absolute z-[2] bg-opacity-90" />
            </nav>
        </>
    )
}
